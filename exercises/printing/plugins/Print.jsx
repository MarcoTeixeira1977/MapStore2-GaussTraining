...
module.exports = {
    PrintPlugin: assign({
        loadPlugin: (resolve) => {
            require.ensure('../../MapStore2/web/client/plugins/print/index', () => {

                const {compose} = require('redux');
                const {setPrintParameter} = require('../../MapStore2/web/client/actions/print');
                ...
                const ExtraParam = connect((state) => ({
                    value: state.print && state.print.spec && state.print.spec.extra || '',
                    type: "text"
                }), {
                    onChange: compose(setPrintParameter.bind(null, 'extra'), (e) => e.target.value)
                })(TextWithLabel);
                        ...
                        return (
                            ...
                            <Row>
                                <Col xs={12} md={6}>
                                    ...
                                    <ExtraParam label="Extra" placeholder="Enter extra..." />
